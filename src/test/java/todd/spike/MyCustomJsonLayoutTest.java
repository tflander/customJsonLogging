...
public class MyCustomJsonLayoutTest {
    ...
    private MyCustomJsonLayout prettyJsonLayout = MyCustomJsonLayout.createLayout(TEST_ENVIRONMENT, true);
    private MyCustomJsonLayout conciseJsonLayout = MyCustomJsonLayout.createLayout(TEST_ENVIRONMENT, false);
    ...
    public void logsException() throws IOException {
        event.setThrown(new Exception("Whoops"));
        logsKeyAndStringValue("exception.0.thrown", "java.lang.Exception:Whoops MyCustomJsonLayoutTest.java todd.spike.MyCustomJsonLayoutTest:logsException line 76");
    }

    @Test
    public void logsFirstCause() throws IOException {
        event.setThrown(new Exception("Whoops", new Exception("First Cause")));
        logsKeyAndStringValue("exception.1.cause", "java.lang.Exception:First Cause MyCustomJsonLayoutTest.java todd.spike.MyCustomJsonLayoutTest:logsFirstCause line 82");
    }
    ...
    public void logsSecondCause() throws IOException {
        ...
        logsKeyAndStringValue("exception.2.cause", "java.lang.Exception:Second Cause MyCustomJsonLayoutTest.java todd.spike.MyCustomJsonLayoutTest:logsSecondCause line 88");
    }
    ...
    private void logsKeyAndStringValueForLayout(String key, String expectedValue, MyCustomJsonLayout jsonLayout) throws IOException {
        String jsonString = jsonLayout.toSerializable(event);
        verifyJsonContainsString(jsonString, key, expectedValue);
    }

    private void logsKeyAndLongValueForLayout(String key, long expectedValue, MyCustomJsonLayout layout) throws IOException {
